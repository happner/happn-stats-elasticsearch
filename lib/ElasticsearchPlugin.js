...
ElasticsearchPlugin.prototype._onReport = function (ts, metrics) {
  ...
  this._storeMetrics(timestamp, 'counters', metrics.counters);
  this._storeMetrics(timestamp, 'gauges', metrics.gauges);
...
ElasticsearchPlugin.prototype._storeMetrics = function (timestamp, type, metrics) {
